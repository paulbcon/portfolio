...
dropBtn.addEventListener("click", e => {
  ...
  if (dropContent.classList.contains('hidedropdown')) {
    dropContent.classList.remove('hidedropdown');
    dropContent.classList.add('showdropdown'); 
  } else {
    dropContent.classList.add('hidedropdown');
    dropContent.classList.remove('showdropdown'); 
  }
});
...
const aboutMeTextContent =
  "I am a Java Full Stack developer & I create website with the best user experience and user interface.";
